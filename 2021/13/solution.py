...
def makeAllFolds(instructions):
	holes, folds = getHolesAndFolds(instructions)
	for axis, midPoint in folds:
		holes = getNewPoints(holes, axis, midPoint)
	plotHoles(holes)

def countHolesAfterFirstFold(instructions):
	holes, folds = getHolesAndFolds(instructions)
...
def solution():
	...
	part1 = str(countHolesAfterFirstFold(instructions))
	print ('Part 1:\n' + part1 + '\n')
	print ('Part 2:')
	makeAllFolds(instructions)
